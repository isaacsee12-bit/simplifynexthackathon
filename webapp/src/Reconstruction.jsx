...
export default function Reconstruction() {
  ...
  return <div className="app-shell">
    <header className="topbar"><a className="brand" href="#top" aria-label="VerifyAI home"><span className="brand-mark">VA</span><span>VerifyAI</span></a><nav className="nav-links" aria-label="Primary navigation"><a href="#verify">Verify</a><a href="#how-it-works">How it works</a><a href="#trust">Why VerifyAI</a></nav><a className="nav-privacy" href="#privacy">Private by design <span>-&gt;</span></a></header>
    <main id="top">
